...
namespace WhatsAppApi.Helper
{
    public class BinTreeNodeWriter
    {
        ...
        #region newer from PHP Version
        protected void writeInt20(int v)
        {
            this.buffer.Add((byte)((0xF0000 & v) >> 16));
            this.buffer.Add((byte)((0xFF00 & v) >> 8));
            this.buffer.Add((byte)((v & 0xFF) >> 0));
        }

        protected void  writeInt31(int v)
        {
            this.buffer.Add((byte)((0x7F000000 & v) >> 24));
            this.buffer.Add((byte)((0xFF0000 & v) >> 16));
            this.buffer.Add((byte)((0xFF00 & v) >> 8));
            this.buffer.Add((byte)((v & 0xFF) >> 0));
        }
        #endregion
